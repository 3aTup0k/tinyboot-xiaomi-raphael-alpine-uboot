...
echo "[$(date +'%Y-%m-%d %H:%M:%S')] [15] 📦 Unmounting and finalizing image"

echo "[$(date +'%Y-%m-%d %H:%M:%S')] [15]   └─ Unmounting mount points..."
...
echo "[$(date +'%Y-%m-%d %H:%M:%S')] [15]   └─ Setting image UUID: ${IMAGE_UUID}"
...
echo "[$(date +'%Y-%m-%d %H:%M:%S')] [15] ✅ Image finalized"
